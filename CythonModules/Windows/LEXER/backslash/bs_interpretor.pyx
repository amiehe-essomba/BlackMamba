...
cdef class BACKSSLASH:
    ...
    cdef:
        ...
        list data_storage 
        bint locked, active_tab, isBreak
        char type_of_backslash, last_char
    ...
    cdef BACKSLASH(self,  unsigned long int _id_ = 1, list MainList = []):
        cdef:
            char str_ 
            str __string__, _string_
            signed long long int i, x
            str w, string_add = ''
            list data_split
            bint loopActivation = False
