...
cdef class ERROR:
    ...
    cpdef str ERROR4(self, str _open_, str _close_):
    ...
    cpdef str ERROR_TREATMENT1(self, str string, str _open_):
    ...
    cpdef str ERROR_TREATMENT2(self, str string, str _close_):
    ...
    cpdef str ERROR_TREATMENT3(self, str string):
    ...
    cpdef str ERROR_TREATMENT4(self, str string, str _open_):
