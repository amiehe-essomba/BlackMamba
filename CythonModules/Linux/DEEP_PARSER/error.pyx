...
cdef class ERRORS:
    ...
    cdef str ERROR2(self, str string):
        self.error = '{}was not found. {}line: {}{}'.format(self.red, self.white, self.yellow, self.line)
        self.error = fe.FileErrors( 'NameError' ).Errors()+'{}<< {} >> '.format(self.cyan, string) + self.error
    ...
    cdef str ERROR5(self, list string, str key):
        ...
        if len(string) <= 4 :  pass 
            ...
            newS  = "[{}, ..., {}, ..., {}]".format(string[0], string[2], string[4])
