            ...
            try:
                ...
                #End-Of-File Error
                    ...
                    if self.string:
                        ...
                        self.loop, self.if_cancel, self.error = eIF.EXTERNAL_IF(master=self.string, data_base = self.data_base, line=self.if_line,
                        ...
                        if self.space <= self.max_emtyLine:
                            self.space += 1
                            self.mainString = self.analyse.BUILD_NON_CON(string=self.string,tabulation=self.tabulation)
