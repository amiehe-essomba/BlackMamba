...
from script.PARXER.PARXER_FUNCTIONS._FOR_.WHILE.WINDOWS     import externalWhile as eWh


class EXTERNAL_WHILE_WINDOWS:
    def __init__(self, 
        data_base   : dict, 
        line        : int,
        term        : str 
            ...
            try:
                ...
                # printing and initializing of values
                    ...
                    if self.string:
                        ...
                        self.loop, self.while_cancel, self.error = eWh.EXTERNAL_WHILE(master=self.string, data_base = self.data_base, line=self.if_line,
