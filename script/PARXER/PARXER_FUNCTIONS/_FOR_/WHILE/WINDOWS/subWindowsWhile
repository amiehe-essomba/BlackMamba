                    ...
                    if self.char is not None:
                        ...
                        # printing and initializing of values "enter"
                            ...
                            if self.string:
                                ...
                                self.loop, self.while_cancel, self.error = IWh.INTERNAL_WHILE(master=self.string, data_base = self.data_base, 
                                    line=self.if_line,  history=self.history, store_value=self.store_value, 
                                    space=self.space ).WHILE(bool_value=bool_value, tabulation=self.tabulation, 
