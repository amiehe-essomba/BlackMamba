...
from script.PARXER.PARXER_FUNCTIONS._FOR_.FOR.WINDOWS   import internalFor as iFor
from script                                             import control_string

class INTERNAL_FOR_WINDOWS:
    def __init__(self, 
            data_base   : dict, 
            line        : int,
            term        : str 
            ...
            try:
                ...
                if self.char not in {10, 13}:
                    ...
                    if self.mainString:
                        ...
                        self.loop, self.for_cancel, self.error = iFor.INTERNAL_FOR(master=self.mainString, data_base = self.data_base, line=self.if_line,
