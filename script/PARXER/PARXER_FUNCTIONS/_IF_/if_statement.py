                            ...
                            if self.error  is None:
                                if self.get_block   == 'begin:'  :
                                    ...
                                    if self.history[ -1 ] in [ 'elif', 'else' ]:
                                        if self.bool_value is True:
                                            self.error = EXTERNAL_IF_LOOP_STATEMENT( master=self.master,
                                    ...
                                    if self.history[ -1 ] in [ 'elif', 'else' ]:
                                        if self.bool_value is True:
                                            self.error = try_statement.EXTERNAL_TRY_FOR_STATEMENT( master=self.master,
                                    ...
                                    if self.history[ -1 ] in [ 'else', 'elif' ]:
                                        if self.bool_value is True:
                                            self.error = unless_statement.EXTERNAL_UNLESS_FOR_STATEMENT( master=self.master,
