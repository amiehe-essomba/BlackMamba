                    ...
                    if self.active_tab is True:
                        ...
                        if self.error  is None:
                            if self.get_block   == 'begin:'  :
                                ...
                                self.error = INTERNAL_IF_STATEMENT( self.master,
                                            self.data_base, self.if_line ).IF_STATEMENT( self.value, self.tabulation + 1, _type_, self.keyPass)
                                ...
                                self.error = unless_statement.INTERNAL_UNLESS_STATEMENT( self.master,
                                ...
                                if self.bool_value is True:
                                    if self.data_base[ 'pass' ] is None:
                                        self.error = self.lex_par.LEXER_AND_PARXER( self.value, self.data_base,
                                                        self.if_line  ).ANALYZE( _id_ = 1, _type_ = _type_)
                            ...
                            if   self.get_block == 'end:'  :
                                ...
                                if self.index_else < 1:
                                    if self.store_value:
                                        ...
                                        if self.bool_key == True: self.bool_value = False
                                        else: self.bool_value       = True
                    ...
                    if self.active_tab is True:
                        ...
                        if self.error  is None:
                            if self.get_block   == 'begin:' :
                                ...
                                self.error = EXTERNAL_IF_STATEMENT(  self.master,
                                        self.data_base, self.line).IF_STATEMENT( self.value, self.tabulation + 1, _type_, self.keyPass)
                                if self.error is None:
                                    self.store_value.append( self.normal_string )
                                    self.history.append( 'if' )
                                    self.space      = 0
                                ...
                                self.error = unless_statement.EXTERNAL_UNLESS_STATEMENT( self.master,
                                            self.data_base, self.line ).UNLESS_STATEMENT( self.value, self.tabulation + 1)
