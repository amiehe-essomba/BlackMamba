...
def a(string: str):
    ...
    if   string == 'add':
        ...
        for i in range(len(List)):
            L.append(len(List[i]))
            List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w ).final(code_w = True )
      
        List = [ bm.words(string="add".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
        ...
        for i in range(len(List)):
            L.append(len(List[i]))
            if i in [8, 9]:
                List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w ).final(n=0, code_w = True )
            else: List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w ).final(n=1, code_w = True )
      
        List = [ bm.words(string="anonymous".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    else: 
        L = [len(string), 10]
        max_ = max(L)+4
        L[0], L[1] = max_, max_
        s =  bm.words(string=f"{string}".center(max_), color=w).final(n=0, code_w = True, blink=True)
        List = [s, ' '.center(max_)]
...
def b( string :str):
    ...
    if   string == 'begin':
        ...
        List = [ bm.words(string="begin".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    else: 
        L = [len(string), 10]
        max_ = max(L)+4
...
def c(string: str): 
    ...
    if     string == 'capitalize':
        ...
        List = [ bm.words(string="capitilize".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'clear':
        ...
        for i in range(len(List)):
            L.append(len(List[i]))
            List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w).final(code_w = True, n=0 )
       
        List = [ bm.words(string="clear".center(max_), color=w).final(n=1, code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'copy':
        ...
        List = [ bm.words(string="copy".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'choice':
        ...
        for i in range(len(List)):
            ...
            List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w).final(code_w = True)
        max_ = max(L)
        List = [ bm.words(string="choice".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'count':
        ...
        List = [ bm.words(string="count".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'conj':
        ...
        List = [ bm.words(string="conj".center(max_), color=w).final(n=1,code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == 'complex':
        ...
        List = [ bm.words(string="complex".center(max_), color=w).final(n=0, code_w = True, blink=True)]+List
        L.insert(0, max_)
    elif   string == "class":
        ...
        for i in range(len(List)):
            L.append(max_)
            index.append(i)
            List[i] = bm.words(string=List[i]+" "  * (max_-len(List[i])), color=w).final(n=1, code_w = True)
        
        List = [ bm.words(string="class".center(max_), color=w).final(n=1, code_w = True, blink=True)]+List
        L.insert(0, max_)
    else: 
        L = [len(string), 10]
        max_ = max(L)+4
