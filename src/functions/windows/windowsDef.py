                    ...
                    if self.char is not None:
                        ...
                        # printing and initializing of values "enter"
                            ...
                            if self.string:
                                ...
                                self.def_cancel, self.error = ED.EXTERNAL_DEF(master=self.string, data_base = self.data_base, line=self.if_line,
                                    ...
                                    class_key=class_key, c=c, function=function, _type_=_type_, term=self.term )
