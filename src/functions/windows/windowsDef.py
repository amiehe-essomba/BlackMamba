                ...
                if self.char:
                    ...
                    if self.char is not None:
                        ...
                        # enter is pressed 
                            ...
                            # writing string 
                            ct.write(self.term, self.Data['input'], self.Data['main_input'], self.color, self.reset, show=True, n=1)
                            #####################################################################################
                            if self.Data['string']:
                                #calling the main module DEF 
                                self.def_cancel, self.error = ED.EXTERNAL_DEF(master=self.Data['string'], data_base = self.data_base, line=self.if_line,
                                    ...
                                    class_key=class_key, c=c, function=function, _type_=_type_, term=self.term, callbacks=self.Data.copy() )
                                ...
                                if self.Data['str_drop_down']:
                                    ...
                                    if self.indicator is None:
                                        ...
                                        if self.error is None: 
                                            ...
                                            ct.write(self.term, self.Data['input'], self.Data['main_input'], self.color, self.reset, n=1)
                                else:
                                    # initialization 
