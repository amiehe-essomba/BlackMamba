                    ...
                    if self.char is not None:
                        ...
                        # enter is pressed 
                            ...
                            if self.Data['string']:
                                ...
                                self.def_cancel, self.error = ID.INTERNAL_DEF(master=self.Data['string'], data_base = self.data_base, line=self.if_line,
                                    ...
                                    _type_=_type_, term=self.term, callbacks=self.Data.copy() )
